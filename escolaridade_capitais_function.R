...
escolaridade_capitais <- function(ano, entrevista=5){
  
  dataname <- paste0 ('data/pnad_anual_', {ano}, '_interview', {entrevista}, '.rds')
  
  pnadc_anual_visita <- import (here (dataname))
...
write.xlsx (db, 'extracted_data/escolaridade_capitais_2017a2023_anual_all5i.xlsx')
